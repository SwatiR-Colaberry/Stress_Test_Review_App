...
const ENTITIES = [
  ...
  },
  {
    ...
    fields: [
      ...
      ["action", "enum", "review_created | review_already_queued | comment_no_marker | comment_rejected_malformed | finalize_allowed | finalize_blocked | retrieval_started | retrieval_completed | retrieval_failed"],
