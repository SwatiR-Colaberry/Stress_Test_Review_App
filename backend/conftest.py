...
file under data/audit/. Every test gets a fresh in-memory trail, both for the
app's FastAPI dependency and for the shared trail scripts use
(get_audit_trail()); tests that need to inspect it override it themselves."""
import pytest
